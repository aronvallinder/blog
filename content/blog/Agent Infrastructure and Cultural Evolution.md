---
title: "Agent Infrastructure and Cultural Evolution"
date: 2026-01-23T14:40:43
---

There's a [new paper](https://arxiv.org/abs/2501.10114) on *agent infrastructure*—"technical systems and shared protocols external to agents that are designed to mediate and influence their interactions with and impacts on their environments."
The authors claim three main functions for agent infrastructure:
1. Attribution: Attributing actions, properties, and other information to agents or users.
2. Interaction: Shaping how agents interact with counterparties.
3. Response: Addressing problems that occur during interaction with an agent. 
