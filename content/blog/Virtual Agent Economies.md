...
- **Trust & safety infrastructure.** There needs to be a way to trace who deployed an agent and what it did — identity systems and audit logs. Agents should have to pass safety checks before they're allowed to participate, and reputation scores help decide who stays in. And for when things break anyway: circuit breakers and kill switches."
