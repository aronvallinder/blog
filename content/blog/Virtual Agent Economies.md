...
- **Permeability controls .** Don't connect the sandbox economy to real-world assets all at once. Start with narrow, controlled interfaces — specific resource types, capped transaction volumes. Dedicated agent currencies add another buffer.
